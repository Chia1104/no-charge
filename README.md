...
An application that manages all your subscription services without costing you a penny! This app is designed to simplify your life by keeping track of all the subscriptions you have signed up for, including streaming services, news apps, music platforms, and more.
...
_We do not recommend deploying a SQLite database on serverless environments since the data wouldn't be persisted. I provisioned a quick Postgresql database on [Zeabur](https://zeabur.com), but you can of course use any other database provider. Make sure the prisma schema is updated to use the correct database._
